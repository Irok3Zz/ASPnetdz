...
namespace krynkoASPproject.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Publisher")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Publisher")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
